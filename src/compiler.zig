...
pub const Parser = struct {
    ...
    fn emitConstant(self: *Parser, constant: f64) !void {
    ...
    const rules = std.EnumMap(TokenType, ParseRule).init(.{
        ...
        .Bang = ParseRule{ .prefix = undefined, .infix = undefined, .precedence = .None },
        .BangEqual = ParseRule{ .prefix = undefined, .infix = undefined, .precedence = .None },
        .Equal = ParseRule{ .prefix = undefined, .infix = undefined, .precedence = .None },
        .EqualEqual = ParseRule{ .prefix = undefined, .infix = undefined, .precedence = .None },
        .Greater = ParseRule{ .prefix = undefined, .infix = undefined, .precedence = .None },
        .GreaterEqual = ParseRule{ .prefix = undefined, .infix = undefined, .precedence = .None },
        .Less = ParseRule{ .prefix = undefined, .infix = undefined, .precedence = .None },
        .LessEqual = ParseRule{ .prefix = undefined, .infix = undefined, .precedence = .None },
        ...
        .False = ParseRule{ .prefix = undefined, .infix = undefined, .precedence = .None },
        ...
        .Nil = ParseRule{ .prefix = undefined, .infix = undefined, .precedence = .None },
        ...
        .True = ParseRule{ .prefix = undefined, .infix = undefined, .precedence = .None },
